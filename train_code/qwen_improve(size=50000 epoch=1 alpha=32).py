...
OUTPUT_DIR = "./train_result/qwen_improve(size=50000 epoch=1 alpha=32)/checkpoints"
LORA_OUTPUT_PATH = "./train_result/qwen_improve(size=50000 epoch=1 alpha=32)/lora"
TEST_FILE_PATH = "zh_med.json"
SAVED_DATA_PATH = "./train_result/qwen_improve(size=50000 epoch=1 alpha=32)/saved_data.json"
IMAGE_SAVE_PATH = "./train_result/qwen_improve(size=50000 epoch=1 alpha=32)"  # 图片保存目录
IGNORE_INDEX = -100
TRAIN_SAMPLE_SIZE = 50000  # 训练样本数量
