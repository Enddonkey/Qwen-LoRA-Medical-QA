...
# ==============================================================================
# 模型路径与训练参数常量
MODEL_ID = "C:/Users/Administrator/.cache/modelscope/hub/models/LLM-Research/Meta-Llama-3-8B"
OUTPUT_DIR = "./train_result/llama_lora/checkpoints"
LORA_OUTPUT_PATH = "./train_result/llama_lora/lora"
TEST_FILE_PATH = "zh_med.json"
SAVED_DATA_PATH = "./train_result/llama_lora/saved_data.json"
IMAGE_SAVE_PATH = "./train_result/llama_lora"  # 图片保存目录
IGNORE_INDEX = -100
...
def load_and_preprocess_data(tokenizer):
    ...
    return instruct_train_dataset, instruct_val_dataset,data_collator
...
def load_model_and_tokenizer():
    ...
    print("tokenizer.pad_token is ", tokenizer.pad_token)
    print("tokenizer.unk_token is ", tokenizer.unk_token)
...
def train_model(model, tokenizer, train_dataset, val_dataset, data_collator):
    """训练模型并返回训练结果"""
    # 初始化训练器
...
def main():
    ...
    # 2. 准备数据
    train_dataset, val_dataset ,data_collator= load_and_preprocess_data(tokenizer)
    ...
    # 3. 训练模型
    trainer = train_model(model, tokenizer, train_dataset, val_dataset, data_collator=data_collator)
