...
OUTPUT_DIR = "./train_result/qwen_improve(size=15000 epoch=5 alpha=16)/checkpoints"
LORA_OUTPUT_PATH = "./train_result/qwen_improve(size=15000 epoch=5 alpha=16)/lora"
TEST_FILE_PATH = "zh_med.json"
SAVED_DATA_PATH = "./train_result/qwen_improve(size=15000 epoch=5 alpha=16)/saved_data.json"
IMAGE_SAVE_PATH = "./train_result/qwen_improve(size=15000 epoch=5 alpha=16)_size"
IGNORE_INDEX = -100
TRAIN_SAMPLE_SIZE = 15000  # 训练样本数量
