...
OUTPUT_DIR = "./train_result/baseline/checkpoints"
LORA_OUTPUT_PATH = "./train_result/baseline/lora"
TEST_FILE_PATH = "zh_med.json"
SAVED_DATA_PATH = "./train_result/baseline/saved_data.json"
IMAGE_SAVE_PATH = "./train_result/baseline"
IGNORE_INDEX = -100
TRAIN_SAMPLE_SIZE = 50  # 训练样本数量
