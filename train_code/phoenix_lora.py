...
# ==============================================================================
# 模型路径与训练参数常量
MODEL_ID = "C:/Users/Administrator/.cache/modelscope/hub/models/AI-ModelScope/phoenix-inst-chat-7b"
OUTPUT_DIR = "./train_result/phoenix_lora/checkpoints"
LORA_OUTPUT_PATH = "./train_result/phoenix_lora/lora"
TEST_FILE_PATH = "zh_med.json"
SAVED_DATA_PATH = "./train_result/phoenix_lora/saved_data.json"
IMAGE_SAVE_PATH = "./train_result/phoenix_lora"  # 图片保存目录
IGNORE_INDEX = -100
...
def main():
    ...
    questions = [data[0] for data in test_data]
    model_answers = []
    for i in range(0, len(questions), batch_size):
        batch = questions[i:i+batch_size]
        batch_answers = generate(batch, return_answer=True, tokenizer=tokenizer, model=model)
